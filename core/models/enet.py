...
class ENet(nn.Module):
    ...
    def __init__(self, nclass, backbone='', aux=False, jpu=False, pretrained_base=None, **kwargs):
        ...
        self.bottleneck1_0 = Bottleneck(14, 16, 64, downsampling=True, **kwargs)
        ...
        self.bottleneck5_0 = UpsamplingBottleneck(64, 4, 14, **kwargs)
        self.bottleneck5_1 = Bottleneck(14, 4, 14, **kwargs)

        self.fullconv = nn.ConvTranspose2d(14, nclass, 2, 2, bias=False)
...
class InitialBlock(nn.Module):
    ...
    def __init__(self, out_channels, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.bn = norm_layer(out_channels + 1)
        self.act = nn.PReLU()
