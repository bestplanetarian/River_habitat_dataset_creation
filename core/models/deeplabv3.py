...
def get_deeplabv3(dataset='pascal_voc', backbone='resnet50', pretrained=False, root='../Trained_weight',
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load(get_model_file('deeplabv3_resnet50_substrate_deeplabv3_best_substrateshadow_model2', root=root),
                              map_location=device))
    return model
