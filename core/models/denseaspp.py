...
def get_denseaspp(dataset='citys', backbone='densenet121', pretrained=False,
                  root='../Trained_weight', pretrained_base=True, **kwargs):
    """DenseASPP
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load(get_model_file('denseaspp_densenet121_substrate_denseaspp_best_substrateshadow_train2', root=root),
                              map_location=device))
    return model
